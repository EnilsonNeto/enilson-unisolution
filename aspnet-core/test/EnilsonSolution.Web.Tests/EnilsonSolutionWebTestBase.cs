...
{
    public abstract class EnilsonSolutionWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static EnilsonSolutionWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(EnilsonSolutionWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<EnilsonSolutionDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<EnilsonSolutionDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<EnilsonSolutionDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<EnilsonSolutionDbContext, Task<T>> func)
        {
            T result;
